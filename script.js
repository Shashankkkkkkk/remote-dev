...
const submitHandler = event => {
    ...
    // prevent default behaviour (default loading)
    ...
    //remove previous job items shown after searched
    jobListSearchEl.innerHTML = '';

    // render spinner after typing in search
    ...
    .then(data => {
        ...
        jobItems.slice(0, 7).forEach(jobItemfun => {
            ...
            <li class="job-item">
                <a class="job-item__link" href="${jobItems[4].id}">
                    ...
                    <div class="job-item__right">
                        ...
                        <time class="job-item__time">${jobItems[4].daysAgo}d</time>
                    </div>
                </a>
            </li>`;
...
const clickHandler = event => {
    ...
    //empty the job details section after clicking on a job
    jobDetailsContentEl.innerHTML = '';

    //render spinner after clicking on a job
    ...
    fetch(`https://bytegrad.com/course-assets/js/2/api/jobs/${id}`)
          ...
          .then(data => {
            ...
            //render job details (show job details as soon as we press a button)

              const jobDetailsHTML = 
              
                 `<img src="${jobItem.coverImgURL}" alt="#" class="job-details__cover-img">

                  <a class="apply-btn" href="#" target="_blank" onClick="return false;">Apply <i class="fa-solid fa-square-arrow-up-right apply-btn__icon"></i></a>
